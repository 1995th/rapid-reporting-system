...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-gray-50 via-white to-gray-100 animate-gradient-slow" />
      
      {/* Animated gradient orbs */}
      <div className="absolute top-1/4 -left-20 w-96 h-96 bg-gray-100/50 rounded-full blur-3xl animate-pulse" />
      <div className="absolute bottom-1/4 -right-20 w-96 h-96 bg-gray-50/50 rounded-full blur-3xl animate-pulse delay-1000" />
